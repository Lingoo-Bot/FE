...
const HomeIcon = ({ active }) => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill={active ? 'var(--mint)' : 'none'}
      stroke={active ? 'var(--mint)' : 'var(--text-3)'}
      strokeWidth="1.8"
...
const ChatIcon = ({ active }) => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill={active ? 'rgba(30,255,184,0.18)' : 'none'}
      stroke={active ? 'var(--mint)' : 'var(--text-3)'}
      strokeWidth="1.8"
      strokeLinejoin="round"
    />
    <line x1="7" y1="8" x2="14" y2="8" stroke={active ? 'var(--mint)' : 'var(--text-3)'} strokeWidth="1.5" strokeLinecap="round"/>
    <line x1="7" y1="12" x2="17" y2="12" stroke={active ? 'var(--mint)' : 'var(--text-3)'} strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
)
